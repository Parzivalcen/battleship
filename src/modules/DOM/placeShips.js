...
board2.placeShip(patrol2, 1, 1,'x');
board2.placeShip(submarine2, 3, 1,'x');
board2.placeShip(destroyer2, 2, 1,'x');
board2.placeShip(battleShip2, 5, 1,'x');
board2.placeShip(carrier2, 8, 1,'x');
